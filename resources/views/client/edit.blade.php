                    ...
                    <div class="col-lg-8">
                        <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                id="client-name-input" placeholder="Enter client name" value="{{$client->name}}">
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="latter"
                                                ...
                                                id="client-sort-name" placeholder="Enter sort name" value="{{$client->latter}}">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="email_address"
                                                ...
                                                id="email-address" placeholder="Enter email address"  value="{{$client->email_address}}">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="contact_number"
                                                ...
                                                id="client-number" placeholder="Enter contact number"  value="{{$client->contact_number}}">
                            ...
                            <div class="card-footer">
                                <div class="text-end">
                                    <a class="btn btn-primary waves-effect waves-light  w-sm" href="/client"
                                        role="button">Back</a>
