                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="security_url"
                                                ...
                                                value="{{ $supplier->security_term_url }}">
