                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                id="project-title-input" placeholder="Enter project title" required>
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="project_cpi"
                                                ...
                                                id="project-cpi" placeholder="Enter Cost Per Complete" required>
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="project_loi"
                                                ...
                                                id="project-loi" placeholder="Enter Length Of Interview" required>
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="project_ir"
                                                ...
                                                id="project-ir" placeholder="Enter Incedance Rate" required>
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="completes"
                                                ...
                                                id="project-complete" placeholder="Enter Number Of Completes" required>
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="date" name="start_date"
                                                ...
                                                id="project-start" placeholder="Enter start date" required>
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="date" name="end_date"
                                                ...
                                                id="project-end" placeholder="Enter end date" required>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="project-test-url"
                                                name="client_live_url" placeholder="Enter Project Live URL" required>
                                        </div>
                                        <div class="col-6 mb-3">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea rows="5" class="form-control" name="description" id="project-description"
                                                placeholder="Type important message here..." required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card body -->
