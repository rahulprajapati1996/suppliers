...
<head>
    ...
    <meta content="Market Research Dashboard" name="description" />
    <meta content="ars" name="author" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" name="password"
                                                    class="form-control pe-5 {{ $errors->first('password') ? 'is-invalid' : '' }}"
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Apr 2022 04:18:05 GMT -->
